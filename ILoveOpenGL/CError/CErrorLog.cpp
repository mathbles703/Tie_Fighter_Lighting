...
void CErrorLog::SetIgnoreBlankStrings(bool bEnabled)
{
	this->m_bIgnoreBlankStrings = bEnabled;
	return;
}
...
//void CErrorLog::m_PrintEndlineCharacter(bool bWriteToCErr /*=false*/, bool bWriteToCout /*=false*/)
//{
//	if ( this->m_bAutoCRLF )
//	{
...
// WARNING: Assumes file is VALID!
void CErrorLog::m_PrintEndlineCharacter_toFile(void)
{
	if ( this->m_bAutoCRLF )
	{
		if ( this->m_bForceFlush )	
...
void CErrorLog::m_PrintEndlineCharacter_toCERR(void)
{
	if ( this->m_bAutoCRLF )
	{
		if ( this->m_bForceFlush )	
...
void CErrorLog::m_PrintEndlineCharacter_toCOUT(void)
{
	if ( this->m_bAutoCRLF )
	{
		if ( this->m_bForceFlush )	
